defmodule Issues.TableFormatter do
	...
	@doc """
		Takes a list of row data, where each row is a HashDict, and a list of headers. Prints a table to STDOUT of the data from each row identified by each header. That is, rach header identifies a column, and those columns are extracted and printed from the rows.
	...
	@doc """
		Given a list or rows, where each row contains a keyed list of columns, return a list containing lists of the data in each column. The `headers` parameter contains the
	...
	@doc """
		Generate the line that goes below the column headings. It is a string of hyphens, with + signs where the verticak bar between the columns goes.
		## Example
		      iex> widths = [5,6,9]
